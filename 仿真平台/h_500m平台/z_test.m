...
SYS_config.UE_height = 500;%UAV飞行高度 100 200 300 500
SYS_config.UE_r = 3



00; %UAV距中心基站的极径  100 300 500 800 1200
...
SYS_config.labelMode = 'English'; %Chinese English 画图模式，图例、坐标轴、标题是采用英文还是中文
