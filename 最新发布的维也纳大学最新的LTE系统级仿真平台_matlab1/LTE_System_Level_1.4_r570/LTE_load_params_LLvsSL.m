...
%% Simulation time
LTE_config.simulation_time_tti = T_TIs; % Simulation time in TTIs
...
LTE_config.UE_cache_file = fullfile(['./data_files/',position_filename]);
...
switch LTE_config.network_source
    case 'generated'
        ...
        LTE_config.macroscopic_pathloss_model = 'SLvsLL';
...
LTE_config.pregenerated_ff_file           = fullfile('./data_files',channel_filename);
