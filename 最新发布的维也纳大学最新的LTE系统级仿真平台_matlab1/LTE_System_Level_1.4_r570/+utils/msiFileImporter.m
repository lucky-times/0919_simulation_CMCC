classdef msiFileImporter
    % Reads out a given folder/s containing antenna .msi files and stores
    % them in a searchable way. Note that this object would not function
    % as needed if it would be inherit from the handle class.
    ...
    methods
        function obj=msiFileImporter(dirname,varargin)
            data_idx = 1;
        ...
        % Get msiFileImporter object containing a subset with the chosen properties
