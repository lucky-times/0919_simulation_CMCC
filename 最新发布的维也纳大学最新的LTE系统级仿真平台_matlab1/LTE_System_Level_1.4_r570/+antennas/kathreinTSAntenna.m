classdef kathreinTSAntenna < antennas.antenna
    ...
    methods
        function obj = kathreinTSAntenna(kathrein_antenna_folder, kathrein_antenna_gain_pattern, frequency,varargin)
            ...
            switch importer
                case 'txap'
                    antenna_data_all            = utils.txapFileImporter(kathrein_antenna_folder);
                case 'msi'
                    antenna_data_all            = utils.msiFileImporter(kathrein_antenna_folder);
                otherwise
                    error('Only "msi" and "txap" antenna files are supported.');
            end
        ...
        function antenna_gain = gain(obj, phi, theta, electrical_tilt, mechanical_tilt)
            ...
            if index_
                ...
                % Mechanical tilting
                    ...
                    vert_gain_pattern = interp1(obj.vertical_degree(:,index_),  obj.vertical_gain_pattern(:,index_)  , wrapTo360(A(:,:,2)) , 'cubic', 'extrap');
