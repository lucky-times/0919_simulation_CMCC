...
%% Simulation time
LTE_config.simulation_time_tti = 25; % Simulation time in TTIs
...
LTE_config.UE_per_eNodeB = 10;    % number of users per eNodeB sector (calculates it for the center sector and applies this user density to the other sectors)
...
if strcmp(LTE_config.antenna.antenna_gain_pattern, 'kathreinTSAntenna')
   ...
   LTE_config.antenna.file_format = 'msi';
